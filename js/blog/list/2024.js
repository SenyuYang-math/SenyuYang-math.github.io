...
btitle[16] = "Bourgain的魔法：环面Schrödinger方程与格点计数"; bdate[16] = "10/26"; bintro[16] = "PDE, 调和分析与数论的美妙联系，Fourier decoupling的先声.";
btitle[17] = "Bourgain的魔法：有限度量空间的Euclidean嵌入"; bdate[17] = "11/17"; bintro[17] = "软几何的硬分析：随机化的思想和尺度分离-平均的技巧.";
btitle[18] = "null form的Strichartz估计 (Ⅰ) : 引子, tube分解"; bdate[18] = "11/26"; bintro[18] = "介绍了主要结果，以及核心工具：tube分解.";
btitle[19] = "Sylvester-Gallai定理的拓扑证明"; bdate[19] = "11/28"; bintro[19] = "对偶，图论与Euler示性数合奏的乐章."
btitle[20] = "null form的Strichartz估计 (Ⅱ) : 尺度归纳，透射项的几何"; bdate[20] = "12/07"; bintro[20] = "引入透射/共振两类作用项，对透射项完成尺度归纳的证明.";
btitle[21] = "null form的Strichartz估计 (Ⅲ) : 向量场方法，局部化与色散"; bdate[21] = "12/15"; bintro[21] = "发轫于Klainerman的几何杰作，并与Fourier视角相结合."
btitle[22] = "null form的Strichartz估计 (Ⅳ) : 控制共振项，局部拼接整体"; bdate[22] = "12/27"; bintro[22] = "系列的正篇内容完结，证明了主要结果.";
// btitle[] = ""; bdate[] = "";
