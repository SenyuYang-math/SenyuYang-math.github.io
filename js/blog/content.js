document.getElementById('blogindex').insertAdjacentHTML('beforebegin', '<p style="margin:20px 0; padding:0"><span style="font-size:25px"><b>' + archYear + '</b></span>&emsp;&emsp;<a href="../blog.html"><b>返回主页</b></a></p>');
for (i=1; i < amount; i++) {
