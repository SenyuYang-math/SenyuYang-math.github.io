document.getElementById('blogindex').insertAdjacentHTML('beforebegin', '<p style="padding:15px 0"><span style="font-size:25px"><b>' + archYear + '</b></span>&emsp;&emsp;<a href="../home.html"><b>返回主页</b></a></p>');
for (i=1; i < amount; i++) {
